                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="section-title">
                                    ...
                                    <h4 class="m-0 text-uppercase font-weight-bold">{{ $categoryName }}
                                        {!! isset($subcategoryName) ? '<i class="fas fa-arrow-right"></i> ' . $subcategoryName : '' !!}</h4>
    ...
    $("#loadMoreBtn").click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // Hide button if fewer than 9 records returned
                if (data.count < 9) {
                    $("#loadMoreBtn").hide();
                }
            }
